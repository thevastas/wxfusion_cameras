#ifndef DALProxy640USBDEF_H
#define DALProxy640USBDEF_H

// Largest image properties expected
#define IRIMAGE_WIDTH 640
#define IRIMAGE_HEIGHT 480
...
/* Module Slot Type (see Proxy640USB_SlotType() ) */
#define SLOT_EMPTY 0
